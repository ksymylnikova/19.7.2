...
def test_add_new_pet_with_valid_data(name='Bobby', animal_type='dog', age='2', pet_photo='images/dog.jpeg'):
...
def test_add_new_pet_with_invalid_age(name='Sony', animal_type='cat', age=invalid_age, pet_photo='images/cat.jpeg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Bobby", "dog", '1', "images/dog.jpeg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
